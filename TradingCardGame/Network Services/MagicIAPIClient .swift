...
final class magicAPIClient {
    static func MagicInfo(completionHandler: @escaping(AppError?,[magicInfo]?)-> Void) {
        NetworkHelper.shared.performDataTask(endpointURLString: "https://api.magicthegathering.io/v1/cards?contains=imageUrl", httpMethod: "GET", httpBody: nil) { (appError, data, httpResponse) 